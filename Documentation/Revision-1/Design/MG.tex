...
\begin{tabularx}{\textwidth}{p{4cm}p{2cm}p{4cm}X}
\toprule {\bf Date} & {\bf Version} & {\bf Developer(s)} & {\bf Notes}\\
\midrule
November 2, 2016 & 1.0 &  Daniel Agostinho & Initial Draft\\
November 2, 2016 & 1.0 & Anthony Chang & Initial Draft\\
November 2, 2016 & 1.0 & Divya Sridhar & Initial Draft\\
December 6, 2016 & 1.1 & Daniel Agostinho & Revision 1\\
\bottomrule
\end{tabularx}
\end{table}
...
\item[\refstepcounter{ucnum} \uctheucnum \label{ucAlgorithm}:] The Algorithm
  for Tetrimino interaction (setting to well and/or clearing a row).
